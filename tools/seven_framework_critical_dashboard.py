...
CRITICAL_ISSUES = [
    # ── DeepSpeed ──
    {
        ...
        "severity": "CRITICAL",
        "status": "BLOCKED",
        "rtx4090": "ZeRO-3+LoRA BROKEN on v0.19.2! ZeRO-2 SAFE. #8076 INDEPENDENTLY CONFIRMED (4xH100 + LLaMA Factory + Qwen3.5-9B)",
        "must": "Use ZeRO-2 + CPU_Adam only",
        "days_open": 5,
        "comments": 0,
        "fix_pr": "#8073 (2-line, 0 reviews, STALLED)",
        "url": "https://github.com/deepspeedai/DeepSpeed/issues/8072",
    },
    {
        "id": "DS-2",
        "framework": "DeepSpeed",
        ...
        "severity": "CRITICAL",
        "status": "OPEN",
        "rtx4090": "MUST overlap_comm=False! 4-point evidence matrix confirmed. Same root cause as verl #6794 record_stream (CUDA stream safety)",
        "severity": "CRITICAL",
        "status": "OPEN",
