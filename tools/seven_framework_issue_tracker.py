...
MONITORED = {
    ...
    "vLLM-Ascend": {
        ...
        "issues": {
            "10684": {"type": "issue", "priority": "CRITICAL", "desc": "DSA Hadamard sleep/wake ALL-ZERO", "our_draft": "P7 C17"},
            "10579": {"type": "pull", "priority": "HIGH", "desc": "MoE NaN 1-line fix 0 reviews", "our_draft": "P6 C13"},
            "10592": {"type": "pull", "priority": "HIGH", "desc": "NPUIPC weight transfer +787 RCE+device bug", "our_draft": "P6 C18"},
            "10724": {"type": "issue", "priority": "HIGH", "desc": "DSV4 PD-Mix crash (8th DSV4 failure)"},
            "10730": {"type": "pull", "priority": "HIGH", "desc": "MX quant fusion 2x speedup"},
            "10710": {"type": "issue", "priority": "HIGH", "desc": "DSV4 prefix cache hit rate 0%"},
            "10700": {"type": "issue", "priority": "CRITICAL", "desc": "GLM5.1 enforce_eager STILL mandatory"},
            "10720": {"type": "issue", "priority": "MEDIUM", "desc": "Qwen3.5-35B overthinking on 300i"},
    ...
    "SGLang": {
        ...
        "issues": {
            ...
            "28701": {"type": "issue", "priority": "MEDIUM", "desc": "Rust radix cache RFC 7317 lines"},
            "28680": {"type": "pull", "priority": "HIGH", "desc": "DFlash grammar constrained decoding +515"},
            "28672": {"type": "pull", "priority": "MEDIUM", "desc": "skip custom all-reduce CUDA graph"},
