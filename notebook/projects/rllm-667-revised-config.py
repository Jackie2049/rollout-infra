...
class TransformConfig:
    ...
    # - "by_task_id": Group all trajectories for the same task together (optimal for GRPO, enables group-level normalization)
    # - "by_task_id_and_name": Group trajectories by task AND agent name (preserves multi-agent separation, e.g. solver+judge)
