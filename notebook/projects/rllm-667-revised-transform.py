...
def _build_trajectory_groups(episodes: list[Episode], compact_filtering_config: CompactFilteringConfig | None = None, grouping_mode: str = "by_task_id") -> list[TrajectoryGroup]:
    """
    ...
    for episode in episodes:
        ...
        for trajectory in episode.trajectories:
            ...
            if grouping_mode == "by_task_id":
                ...
                raise ValueError(f"Unknown grouping_mode: {grouping_mode}. Must be 'by_task_id' or 'by_task_id_and_name'")
...
def _default_traj_grouping_hook(episodes: list[Episode], transform_config: TransformConfig, compact_filtering_config: CompactFilteringConfig | None = None) -> list[TrajectoryGroup]:
    ...
    """
    trajectory_groups = _build_trajectory_groups(episodes, compact_filtering_config, grouping_mode=transform_config.grouping_mode)  # part 1
