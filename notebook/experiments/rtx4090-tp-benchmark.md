...
> 2026-06-05 | 4x/8x RTX 4090, NCCL, PCIe (无 NVLink)
...
| 操作 | 数据大小 | 延迟 (ms) | 带宽 (GB/s) |
|------|----------|-----------|-------------|
| AllReduce | 1024² (2 MB) | 0.75 | 4.9 |
| AllReduce | 4096² (32 MB) | 11.29 | 5.2 |
| AllReduce | 16384² (512 MB) | 179.79 | 5.2 |
| AllGather | 4096² (32 MB) | 5.85 | 5.7 |
| ReduceScatter | 4096² (32 MB) | 5.97 | 5.6 |

**关键发现**: TP=4 和 TP=8 带宽几乎相同 (~5-6 GB/s), 说明瓶颈是 PCIe 总线拓扑, 不是 GPU 数量。
...
TP=8 结果与 TP=4 几乎一致, 确认瓶颈是 PCIe 带宽而非 GPU 数量。AllReduce BW: TP=8 约 5.2 GB/s vs TP=4 约 5.0 GB/s。
